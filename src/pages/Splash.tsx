...
import andy4 from '../assets/andy_4.png';
...
export default function Splash() {
    ...
    return (
        <div className="h-screen w-screen bg-background-lavender">
            {/* splash image and title */}
            <div className="fixed h-screen font-[new-spirit]">
                <div
                    className={`transform] absolute top-[40px] left-[30px] h-[150] w-[131px] text-right text-[95px] font-bold leading-[5rem] tracking-tighter transition-transform duration-200	ease-out	${
                ...
                <div
                    className={`absolute top-[-110px] left-[205px] z-20 h-[150] w-[131px]  text-[300px] font-semibold tracking-[-0.07em] transition-transform delay-500 duration-200	ease-out	${
                ...
                <div
                    className={`absolute left-[-45px] top-[130px] h-[150] w-[131px]  text-[300px] font-semibold tracking-[-0.07em] transition-transform delay-[400ms] duration-[400ms]	ease-out	${
            ...
            >
                <img
                    src={andy3}
                    className={`absolute bottom-[-50px] origin-bottom-left scale-[0.65] transition duration-300 ease-in-out hover:opacity-50 `}
                />
            </div>
            <div className={` overflow-hidden`}>
                <img
                    src={andy4}
                    className="absolute bottom-0 ml-12 origin-bottom-right translate-y-6 scale-[0.75]"
                />
            </div>
            <Link to="/resume">
                <div className=" absolute bottom-48 left-1/2 h-[68px]  w-[234px] -translate-x-1/2 border-[3px] border-black bg-header-orange pt-[10px] text-center font-sans text-4xl font-bold tracking-tighter drop-shadow-heavy transition duration-150 ease-in-out hover:scale-110">
                    RESUME
                </div>
            </Link>
        </div>
